...
public class CalendarPanel extends JPanel {
    ...
    private void buildUI() {
        ...
        pastNoteArea.setBackground(new Color(120, 35, 28));   
    ...
    private void buildGrid() {
        ...
        for (int d = 1; d <= daysInMonth; d++) {
            ...
            if (isSel) {
                ...
                fg = UI.POMO_RED;
                hoverBg = new Color(255, 180, 180);
                font = new Font("Segoe UI", Font.BOLD, 12);
            } else if (isPast) {
                bg = new Color(140, 42, 33);
                fg = new Color(210, 165, 162);
                hoverBg = new Color(150, 46, 36);
                font = new Font("Segoe UI", Font.PLAIN, 12);
            } else {
                bg = new Color(175, 50, 40);
                fg = Color.WHITE;
                hoverBg = new Color(155, 38, 30);
                font = new Font("Segoe UI", Font.PLAIN, 12);
            }
